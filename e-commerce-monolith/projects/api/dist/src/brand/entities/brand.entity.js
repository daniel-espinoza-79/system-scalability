...
const prisma_category_product_entity_1 = require("../../product/entities/prisma-category-product.entity");
class Brand {
}
__decorate([
...
__decorate([
    (0, swagger_1.ApiProperty)({
        type: () => prisma_category_product_entity_1.default,
        isArray: true,
        description: 'The products of the brand',
    }),
